import {
  ...
  useReducedMotion,
  useTransform
} from "./chunk-DBEVT5NF.js";
import {
  transform
} from "./chunk-AQO2DGVA.js";
import {
  require_react_dom
...
// node_modules/react-modal-sheet/dist/index.mjs
var SheetContext = (0, import_react3.createContext)(
  void 0
);
function useSheetContext() {
  const context = (0, import_react3.useContext)(SheetContext);
...
var SheetBackdrop = (0, import_react3.forwardRef)(
...
var SheetContainer = (0, import_react3.forwardRef)(
...
function useDragConstraints() {
  ...
  const onMeasure = (0, import_react3.useCallback)(() => constraints, []);
...
function useScrollPosition(options = {}) {
  ...
  const [scrollPosition, setScrollPosition] = (0, import_react3.useState)(void 0);
...
var SheetContent = (0, import_react3.forwardRef)(
  ({
...
var SheetHeader = (0, import_react3.forwardRef)(
  ({ children, style, disableDrag, unstyled, className = "", ...rest }, ref) => {
    ...
    return import_react3.default.createElement(
      ...
      children || import_react3.default.createElement("div", { className: "react-modal-sheet-header", style: headerStyle }, import_react3.default.createElement(SheetDragIndicator, null))
    );
  }
);
SheetHeader.displayName = "SheetHeader";
var useIsomorphicLayoutEffect = IS_SSR ? import_react3.useEffect : import_react3.useLayoutEffect;
...
function useSafeAreaInsets() {
  const [insets] = (0, import_react3.useState)(() => {
...
function useStableCallback(handler) {
  const handlerRef = (0, import_react3.useRef)(void 0);
  useIsomorphicLayoutEffect(() => {
...
function useSheetState({
  ...
  const [state, setState] = (0, import_react3.useState)(isOpen ? "opening" : "closed");
...
function useVirtualKeyboard(options = {}) {
  ...
  const focusedElementRef = (0, import_react3.useRef)(null);
...
var Sheet = (0, import_react3.forwardRef)(
  ({
    avoidKeyboard = true,
    children,
    className = "",
    ...
    const [currentSnap, setCurrentSnap] = (0, import_react3.useState)(initialSnap);
    ...
    const sheet = import_react3.default.createElement(SheetContext.Provider, { value: context }, import_react3.default.createElement(
      motion.div,
      {
        ...rest,
        ref,
